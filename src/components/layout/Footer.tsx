  ...
  return (
    <footer className="bg-neutral-900 text-white py-12">
      <div className="container-custom">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#skills" className="text-neutral-400 hover:text-white transition-colors">Skills</a></li>
                <li><a href="#portfolio" className="text-neutral-400 hover:text-white transition-colors">Portfolio</a></li>
                <li><a href="#resume" className="text-neutral-400 hover:text-white transition-colors">Resume</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  <a href="mailto:contact@ulysseskai.com" className="text-neutral-400 hover:text-white transition-colors">
                    contact@ulysseskai.com
                  </a>
                </li>
                <li className="flex items-center">
        ...
        <div className="pt-8 border-t border-neutral-800 text-neutral-500 flex flex-col sm:flex-row justify-between items-center">
          <p>&copy; {currentYear} Ulysses Kai. All rights reserved.</p>
          <div className="mt-4 sm:mt-0">
            <a href="#" className="text-neutral-500 hover:text-white transition-colors mr-6">Privacy Policy</a>
